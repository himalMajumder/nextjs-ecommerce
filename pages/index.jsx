...
export default function Home() {
	return (
		<>
			<Head>
				<title>E-commerce - Wear the code</title>
				<meta name="description" content="E-commerce - Wear the code" />
				<meta
					name="viewport"
			...
			<section className="text-gray-600 body-font">
				<div className="container px-5 py-24 mx-auto">
					<div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
						<h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the code with E-commerce</h1>
