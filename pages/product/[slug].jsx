        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-16 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/W/IMAGERENDERING_521856-T2/images/I/71cs6CAujzL._AC_UL1500_.jpg" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex">
                            ...
                            <button onClick={() => addToCart(1012, 1, 1020, 'Wear the code (XL, RED)', 'X', 'Red')} className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
                        ...
                        <div className="pin mt-6 space-x-2 text-sm">
                            <input type="number" onChange={onChangePin} placeholder="Enter your Pincode " className='px-2  border-2 border-gray-400 rounded-md' />
                            <button onClick={checkServiceability} type='button' className="ml-14 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded"> Check</button>
                        </div>
